## SISG2022 R code for exercises

## Load data
cholesterol = read.csv("https://raw.githubusercontent.com/rhubb/SISG2022/master/data/SISG-Data-cholesterol.csv", head=T)
attach(cholesterol)
...
# adjusting for triglycerides
glm.mod5 <- glm(HTN ~ TG+factor(rs174548), family = "gaussian")
